...
import com.yinker.etl.pm.model.PmKettleChannelLogQuery;
import com.yinker.etl.pm.model.base.PmKettleChannelLog;
import com.yinker.etl.pm.service.PmKettleChannelLogService;
...
/** 
 * <pre>
 * <b>类描述:</b>PmKettleChannelLog表对应的Action类。
 * <b>作者:</b>李玉强
 * <b>创建日期:</b>2017-12-26 14:56:13
 * </pre>
 */
public class PmKettleChannelLogAction extends BaseStruts2Action {
    private static final long serialVersionUID = 1L;

    private static final Logger LOGGER = LoggerFactory.getLogger(PmKettleChannelLogAction.class);

    /* 定义业务实体对象，用于新增/修改/查看 */
    protected PmKettleChannelLog entity;

    /* 定义查询类业务实体对象，用于查询条件对象 */
    protected PmKettleChannelLogQuery queryEntity;

    /* 定义服务层操作类 */
    protected PmKettleChannelLogService entityService;
	 ...
	 */
	public void init(){
		entity = new PmKettleChannelLog();
		queryEntity = new PmKettleChannelLogQuery();
	}
    public PmKettleChannelLogAction() {
    }
    ...
    /*public String create() throws Exception {
        if ("toCreate".equals(operate)) {// 转向新增页面
			...
			// 设置Id
			String id = keyGeneratorContainer.getNextKey("pmKettleChannelLogId");
            entity.setId(id);
    ...
    /*public String delete() throws Exception {
		...
		if (StringUtils.isNotEmpty(selectedIds)) {
			...
			for (int i = 0; i < idArray.length; i++) {
                PmKettleChannelLogPK pk = new PmKettleChannelLogPK();
				pk.setId(idArray[i]);
        ...
        entityService.deleteByPK((PmKettleChannelLogPK)entity);
        return PROMPT;
    }*/
    ...
    public String view() throws Exception {
		...
		PmKettleChannelLog pmKettleChannelLog =  entityService.selectByPK(entity);
        if (entity == null) {
           throw new Exception("对象不存在,查询条件:" + entity.pkString());
        } else {
			entity = pmKettleChannelLog;
		}
	...
	public PmKettleChannelLog getEntity() {
        return entity;
    }

    public void setEntity(PmKettleChannelLog entity) {
        this.entity = entity;
    }

    public PmKettleChannelLogQuery getQueryEntity() {
        return queryEntity;
    }

    public void setQueryEntity(PmKettleChannelLogQuery queryEntity) {
        this.queryEntity = queryEntity;
    }

    public void setEntityService(PmKettleChannelLogService entityService) {
