...
public class PmMongoTransferTableNameInfoPK extends BasePageQuery implements BaseEntityPK {
	 ...
	 * 表的名称 
	 */
	public static final String TABLE_NAME = "pm_mongo_transfer_table_name_info";
    ...
    public String getEntityName() {
        return PmMongoTransferTableNameInfoPK.TABLE_NAME;
    }
