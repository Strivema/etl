...
import com.yinker.etl.pm.model.PmOperationLogQuery;
import com.yinker.etl.pm.model.base.PmOperationLog;
import com.yinker.etl.pm.model.base.PmOperationLogPK;
import com.yinker.etl.pm.service.PmOperationLogService;

/** 
 * <pre>
 * <b>类描述:</b>PmOperationLog表对应的Action类。
 * <b>作者:</b>李玉强
 * <b>创建日期:</b>2017-11-06 10:39:45
 * </pre>
 */
public class PmOperationLogAction extends BaseStruts2Action {
    private static final long serialVersionUID = 1L;

    private static final Logger LOGGER = LoggerFactory.getLogger(PmOperationLogAction.class);

    /* 定义业务实体对象，用于新增/修改/查看 */
    protected PmOperationLog entity;

    /* 定义查询类业务实体对象，用于查询条件对象 */
    protected PmOperationLogQuery queryEntity;

    /* 定义服务层操作类 */
    protected PmOperationLogService entityService;
	 ...
	 */
	public void init(){
		entity = new PmOperationLog();
		queryEntity = new PmOperationLogQuery();
	}
    public PmOperationLogAction() {
    }
    ...
    public String create() throws Exception {
        if ("toCreate".equals(operate)) {// 转向新增页面
			...
			// 设置Id
			String id = keyGeneratorContainer.getNextKey("pmOperationLogId");
            entity.setId(id);
    ...
    public String delete() throws Exception {
		...
		if (StringUtils.isNotEmpty(selectedIds)) {
			...
			for (int i = 0; i < idArray.length; i++) {
                PmOperationLogPK pk = new PmOperationLogPK();
				pk.setId(idArray[i]);
        ...
        entityService.deleteByPK((PmOperationLogPK)entity);
        return PROMPT;
    }
    ...
    public String view() throws Exception {
		...
		PmOperationLog pmOperationLog =  entityService.selectByPK(entity);
        if (entity == null) {
           throw new Exception("对象不存在,查询条件:" + entity.pkString());
        } else {
			entity = pmOperationLog;
		}
	...
	public PmOperationLog getEntity() {
        return entity;
    }

    public void setEntity(PmOperationLog entity) {
        this.entity = entity;
    }

    public PmOperationLogQuery getQueryEntity() {
        return queryEntity;
    }

    public void setQueryEntity(PmOperationLogQuery queryEntity) {
        this.queryEntity = queryEntity;
    }

    public void setEntityService(PmOperationLogService entityService) {
