...
/**
 * <pre>
 * <b>类描述:</b>PmKettleTransLog表的对应的java对象，该文件为工具自动生成，请勿手工修改!
 * <b>作者:</b>李玉强
 * <b>创建日期:</b>2017-11-06 10:39:48
 * </pre>
 */
public class PmKettleTransLog extends PmKettleTransLogPK {
    ...
    /* 关联对象-子表信息 */
   /* private List<PmKettleChannelLog> pmKettleChannelLogs;

    public List<PmKettleChannelLog> getPmKettleChannelLogs () {
        return pmKettleChannelLogs;
    }

    public void setPmKettleChannelLogs (List<PmKettleChannelLog> pmKettleChannelLogs) {
        this.pmKettleChannelLogs = pmKettleChannelLogs;
    }*/
