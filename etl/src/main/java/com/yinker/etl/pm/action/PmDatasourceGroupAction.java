...
/** 
 * <pre>
 * <b>类描述:</b>PmDatasourceGroup表对应的Action类。
 * <b>作者:</b>李玉强
 * <b>创建日期:</b>2017-12-15 19:25:51
 * </pre>
 */
public class PmDatasourceGroupAction extends BaseStruts2Action {
    private static final long serialVersionUID = 1L;

    private static final Logger LOGGER = LoggerFactory.getLogger(PmDatasourceGroupAction.class);

    /* 定义业务实体对象，用于新增/修改/查看 */
    protected PmDatasourceGroup entity;

    /* 定义查询类业务实体对象，用于查询条件对象 */
    protected PmDatasourceGroupQuery queryEntity;

    /* 定义服务层操作类 */
    protected PmDatasourceGroupService entityService;
	 ...
	 */
	public void init(){
		entity = new PmDatasourceGroup();
		queryEntity = new PmDatasourceGroupQuery();
	}
    public PmDatasourceGroupAction() {
    }
    ...
    public String create() throws Exception {
        if ("toCreate".equals(operate)) {// 转向新增页面
			...
			// 设置Id
			String id = keyGeneratorContainer.getNextKey("pmDatasourceGroupId");
            entity.setId(id);
    ...
    public String delete() throws Exception {
		...
		if (StringUtils.isNotEmpty(selectedIds)) {
			...
			for (int i = 0; i < idArray.length; i++) {
                PmDatasourceGroupPK pk = new PmDatasourceGroupPK();
				pk.setId(idArray[i]);
        ...
        entityService.deleteByPK((PmDatasourceGroupPK)entity);
        return PROMPT;
    }
    ...
    public String view() throws Exception {
		...
		PmDatasourceGroup pmDatasourceGroup =  entityService.selectByPK(entity);
        if (entity == null) {
           throw new Exception("对象不存在,查询条件:" + entity.pkString());
        } else {
			entity = pmDatasourceGroup;
		}
	...
	public PmDatasourceGroup getEntity() {
        return entity;
    }

    public void setEntity(PmDatasourceGroup entity) {
        this.entity = entity;
    }

    public PmDatasourceGroupQuery getQueryEntity() {
        return queryEntity;
    }

    public void setQueryEntity(PmDatasourceGroupQuery queryEntity) {
        this.queryEntity = queryEntity;
    }

    public void setEntityService(PmDatasourceGroupService entityService) {
