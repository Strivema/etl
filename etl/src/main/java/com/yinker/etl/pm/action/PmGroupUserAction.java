...
/** 
 * <pre>
 * <b>类描述:</b>PmGroupUser表对应的Action类。
 * <b>作者:</b>李玉强
 * <b>创建日期:</b>2017-12-15 19:25:49
 * </pre>
 */
public class PmGroupUserAction extends BaseStruts2Action {
    private static final long serialVersionUID = 1L;

    private static final Logger LOGGER = LoggerFactory.getLogger(PmGroupUserAction.class);

    /* 定义业务实体对象，用于新增/修改/查看 */
    protected PmGroupUser entity;

    /* 定义查询类业务实体对象，用于查询条件对象 */
    protected PmGroupUserQuery queryEntity;

    /* 定义服务层操作类 */
    protected PmGroupUserService entityService;
	 ...
	 */
	public void init(){
		entity = new PmGroupUser();
		queryEntity = new PmGroupUserQuery();
	}
    public PmGroupUserAction() {
    }
    ...
    public String create() throws Exception {
        if ("toCreate".equals(operate)) {// 转向新增页面
			...
			// 设置Id
			String id = keyGeneratorContainer.getNextKey("pmGroupUserId");
            entity.setId(id);
    ...
    public String delete() throws Exception {
		...
		if (StringUtils.isNotEmpty(selectedIds)) {
			...
			for (int i = 0; i < idArray.length; i++) {
                PmGroupUserPK pk = new PmGroupUserPK();
				pk.setId(idArray[i]);
        ...
        entityService.deleteByPK((PmGroupUserPK)entity);
        return PROMPT;
    }
    ...
    public String view() throws Exception {
		...
		PmGroupUser pmGroupUser =  entityService.selectByPK(entity);
        if (entity == null) {
	...
	public PmGroupUser getEntity() {
        return entity;
    }

    public void setEntity(PmGroupUser entity) {
        this.entity = entity;
    }

    public PmGroupUserQuery getQueryEntity() {
        return queryEntity;
    }

    public void setQueryEntity(PmGroupUserQuery queryEntity) {
        this.queryEntity = queryEntity;
    }

    public void setEntityService(PmGroupUserService entityService) {
