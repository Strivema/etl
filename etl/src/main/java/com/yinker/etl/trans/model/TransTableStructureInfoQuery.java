...
/** 
 * <pre>
 * <b>类描述:</b>TransTableStructureInfo表的对应的查询对象，增加Date/Double/int型字段的区间查询属性字段。
 * <b>作者:</b>李玉强
 * <b>创建日期:</b>2017-11-21 15:58:42
 * </pre>
 */ 
public class TransTableStructureInfoQuery extends TransTableStructureInfo {
    ...
    public String toString() {
        ...
        str.append("	compareParameter=").append(getCompareParameter()).append(SystemUtils.LINE_SEPARATOR);
